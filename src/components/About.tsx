  ...
  return (
    <div className="relative bg-black px-12 py-4">
      <section className="relative flex min-h-screen items-center justify-center">
        ...
        >
          <h1 className="mb-7 text-4xl font-extrabold text-white sm:text-5xl lg:text-5xl lg:leading-normal">
          ...
          <section className="justify-center">
            <div className="text-[#ADB7BE] sm:text-lg">
              <div className="text-4xl font-extrabold text-white sm:text-5xl lg:mb-24 lg:text-3xl lg:leading-normal"></div>
              <p className="text-[#ADB7BE] sm:text-lg">
            ...
            <div className="text-[#ADB7BE] sm:text-lg">
              <div className="text-4xl font-extrabold text-white sm:text-5xl lg:mb-28 lg:text-5xl lg:leading-normal">
