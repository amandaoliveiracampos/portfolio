...
export default function Experience() {
  return (
    <div
      id="experience"
      className="relative bg-black px-8 py-4 sm:px-12 lg:px-12 lg:py-4"
    >
      <section className="relative flex flex-col items-center justify-center">
        ...
        >
          <h1 className="mb-12 mt-8 text-3xl font-extrabold text-white sm:text-5xl lg:mb-16 lg:mt-28 lg:text-5xl">
            {' '}
          ...
          <div className="mt-12 flex w-full flex-col gap-4 sm:mt-20 lg:mt-32 lg:flex-col lg:gap-5">
            ...
            <button className="mb-16 flex w-full items-center justify-center bg-gradient-to-br from-primary-500 to-secondary-500">
              <div className="flex w-full justify-between rounded-md p-4 text-start transition duration-300 ease-in-out hover:scale-110 sm:p-6 lg:h-20 lg:w-[650px] lg:p-6">
                <span className="flex-1">
